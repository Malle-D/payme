                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => Container(
                            margin: EdgeInsets.only(left: index ==0 ? 16 : 8, right: index == 9 ? 16 : 0),
                            width: 110,
                            height: 100,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) =>
                            ...
                            child: Row(
                              ...
                              margin: EdgeInsets.only(left: index ==0 ? 16 : 8, right: index == 1 ? 16 : 0),
                              width: 300,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(12),
                                  color: Color(0xFF32353F)
                              ...
                              child: Row(
                                children: [
                                  SizedBox(width: primaryPadding,),
                                  Icon(Icons.home, size: 24, color: Color(darkerWhiteColor),),
                                  SizedBox(width: primaryPadding,),
                                  Text('Uy qo`shish',style: TextStyle(fontSize: 15, color: Color(darkerWhiteColor), fontWeight: FontWeight.w500), overflow: TextOverflow.ellipsis, maxLines: 2, textAlign: TextAlign.center,),
                                  Spacer(),
                                  Icon(Icons.add, color: Color(0xFF989EA3),),
                                  SizedBox(width: primaryPadding,)
                                ],
                              ),
                            ),
